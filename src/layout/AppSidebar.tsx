...
import { SidebarMenus } from "@/components/menu/SidebarMenus";
...
const AppSidebar: React.FC = () => {
  ...
  const renderMenuItems = (menus: NavItem[]) => (
          ...
          {isExpanded || isHovered || isMobileOpen ? (
            <>
              <Image
                ...
                src="/images/logo/jajanan-blue.png"
                alt="Logo"
                width={120}
                height={40}
              />
            ...
            <Image
              src="/images/logo/jajanan-icon-blue.png"
              alt="Logo"
              width={32}
              height={32}
            />
